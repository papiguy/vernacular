...
#### Editor interaction and edit feedback (merged)
...
| Live drag previews (ghosts) and cursor-adjacent readouts             | ADR-0072 / #138 | merged |
| Openings drag-to-resize handles with extend and snap to the wall end | ADR-0073 / #141 | merged |
| Free-angle modifier when editing an existing wall endpoint           | ADR-0074 / #144 | merged |
...
| Lighting legibility (rebalanced rig so adjacent walls separate by value)   | ADR-0079 / #161 | merged  |
...
| Old-house vocabulary       | Era tagging UI (period and style overrides)                           | merged (#109)                  |
...
| Output and export          | PNG (image) plan export (canvas rasterization)                        | merged (#113)                  |
| Output and export          | PDF (document) plan export                                            | merged (#128)                  |
