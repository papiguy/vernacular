  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'editor/plan/selected-opening.ts',
        'editor/plan/selected-dimension.ts',
        'editor/plan/drawable-openings.ts',
        'editor/plan/drawable-dimensions.ts',
        'editor/plan/opening-tool-context.ts',
        'editor/plan/opening-type-chooser.tsx',
        'editor/plan/use-opening-placement.ts',
